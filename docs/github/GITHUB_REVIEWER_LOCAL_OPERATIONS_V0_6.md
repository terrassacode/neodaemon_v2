# GITHUB_REVIEWER_LOCAL_OPERATIONS_V0_6

## Estado

Activo localmente.

Este documento describe la operación local del reviewer Git/GitHub de NeoDaemon.

No contiene logs, snapshots, tokens, credenciales ni datos sensibles.

## Objetivo

Mantener una revisión automática local del estado Git del repositorio `neodaemon_v1` y generar un resumen humano fácil de leer.
...
No borrar automáticamente logs, snapshots ni resúmenes salvo decisión explícita.

## Advertencia importante

No subir logs, snapshots ni secretos.
